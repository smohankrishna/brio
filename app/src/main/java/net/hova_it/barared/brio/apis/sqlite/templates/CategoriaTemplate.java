...
/**
 * Maneja los metodos Insert y Select en Sqlite para el modelo Categoria.
 * Created by Alejandro Gomez on 16/12/2015.
 */
public class CategoriaTemplate extends Synchronizable {
    private final String TAG = "BRIO_DB";
    private final String TABLE = "Categorias"; // TODO
    private final String key = "id_categoria"; // TODO

    private SQLiteService sqLiteService;
    private SQLiteInit query;
    private long executionTime;

    public CategoriaTemplate(SQLiteService sqLiteService){
    ...
    public Long insert(Categoria categoria){
        ...
        int _id = categoria.getIdCategoria();
        boolean isNew = true;
        ...
        SQLiteStatement stmt = db.compileStatement(query.replaceIntoCategorias());

        stmt.bindLong(1, _id);
        stmt.bindString(2, categoria.getNombre()); // ANY TEXT
    ...
    public List<Categoria> select(String where){
        ...
        while(resource.moveToNext()){
            ...
            categoria.setIdCategoria(resource.getInt(0));
            categoria.setNombre(resource.getString(1));
