 ...
 */
public class ReportesFragment_bkp extends OptionMenuFragment implements View.OnClickListener{

    public final static String KEY_LOG = ReportesFragment_bkp.class.getSimpleName();
    ...
    private ReportesVentasAdapter mVentasAdapter;
    private ReportesServiciosAdapter mServiciosAdapter;
    private ReportesTransaccionesTarjetaAdapter mTarjetaAdaptadminer;
    ...
    public ReportesFragment_bkp(){}

    public static ReportesFragment_bkp getInstance(int report){
        ReportesFragment_bkp reportesFragment = new ReportesFragment_bkp();
            ...
            if (tFechaFin > tFechaInicio) {
                ...
                loading.setVisibility(View.VISIBLE);
                    switch (tipoReporte) {
                        ...
                        case 5: // Este menu es el de Detalle estado de cuenta - Comentado por: Manuel Delgadillo 25/02/2017
