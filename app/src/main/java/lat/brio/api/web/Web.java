...
/**
 * Created by Delgadillo on 15/04/17.
 */
...
public class Web extends WebView {
        ...
        protected Web.Listener mListener;
    ...
    public void setListener(final Activity activity, final Web.Listener listener) {
        setListener(activity, listener, REQUEST_CODE_FILE_PICKER);
    }

    public void setListener(final Activity activity, final Web.Listener listener, final int requestCodeFilePicker) {
        if (activity != null) {
    ...
    public void setListener(final Fragment fragment, final Web.Listener listener) {
        setListener(fragment, listener, REQUEST_CODE_FILE_PICKER);
    }

    public void setListener(final Fragment fragment, final Web.Listener listener, final int requestCodeFilePicker) {
        if (fragment != null) {
    ...
    protected void setListener(final Web.Listener listener, final int requestCodeFilePicker) {
        mListener = listener;
     ...
     * @param fromUrl the URL of the file to download, e.g. the one from `Web.onDownloadRequested(...)`
    ...
    public static boolean handleDownload(final Context context, final String fromUrl, final String toFilename) {
        ...
        // if the download manager app has been disabled on the device
            ...
            openAppSettings(context, Web.PACKAGE_NAME_DOWNLOAD_MANAGER);
