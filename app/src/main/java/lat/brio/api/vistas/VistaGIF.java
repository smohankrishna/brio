...
/**
 * Created by Delgadillo on 16/05/17.
 */
 ...
 * Gifview
 */
public class VistaGIF extends View {
    ...
    public VistaGIF(Context context) {
        this(context, null);
    }

    public VistaGIF(Context context, AttributeSet attrs) {
        this(context, attrs, R.styleable.CustomTheme_vistaGifEstilo);
    }

    public VistaGIF(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void setViewAttributes(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray array = context.obtainStyledAttributes(attrs,
                R.styleable.VistaGIF, defStyle, R.style.Widget_VistaGif);

        //-1 is default value
        mMovieResourceId = array.getResourceId(R.styleable.VistaGIF_gif, -1);
        mPaused = false; //array.getBoolean(R.styleable.VistaGIF_pausa, false);
